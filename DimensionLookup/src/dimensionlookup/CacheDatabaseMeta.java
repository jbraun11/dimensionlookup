...
@DatabaseMetaPlugin(type="DIMCACHE", typeDescription="H2 Memory Database for Dimension Lookup")
public class CacheDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
	...
	public String getURL(String hostname, String port, String databaseName) {
		if (getAccessType() == DatabaseMeta.TYPE_ACCESS_NATIVE) {
			// If the database is an in-memory DB or if there is no valid port
			// and hostname, go embedded
			//
	...
	/**
	 * @see DatabaseInterface#getSchemaTableCombination(java.lang.String,
	 *      java.lang.String)
	 */
	@Override
	...
	public String[] getReservedWords() {
		return new String[] { "CURRENT_TIMESTAMP", "CURRENT_TIME", "CURRENT_DATE", "CROSS", "DISTINCT", "EXCEPT",
				"EXISTS", "FROM", "FOR", "FALSE", "FULL", "GROUP", "HAVING", "INNER", "INTERSECT", "IS", "JOIN", "LIKE",
				"MINUS", "NATURAL", "NOT", "NULL", "ON", "ORDER", "PRIMARY", "ROWNUM", "SELECT", "SYSDATE", "SYSTIME",
				"SYSTIMESTAMP", "TODAY", "TRUE", "UNION", "WHERE", };
	}
